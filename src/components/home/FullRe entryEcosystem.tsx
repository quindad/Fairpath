      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/70 mb-6">
                When you hire through FairPath Staffing, you're not just getting an employee. 
                You're getting someone with stable housing (we helped secure it), reliable transportation 
                (we arranged it), and ongoing support (we provide it). That's why our placements have 
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="bg-white/5 border-white/10 p-6">
              ...
              <p className="text-white/80 text-sm mb-4">
                "The FastTrack housing program changed everything. I had a place to live on day one. 
        ...
        <div className="text-center">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
            Whether you're currently incarcerated, recently released, or years into your second chance, 
