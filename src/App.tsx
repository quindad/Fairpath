...
import EmployersPage from './components/website/EmployersPage';
import PropertyOwnersPage from './components/website/PropertyOwnersPage';
import FairPathStaffingPage from './components/website/FairPathStaffingPage';
import EmployerListingsPage from './components/website/EmployerListingsPage';
import FriendAVeteranPage from './components/website/FriendAVeteranPage';
import SystemArchitecturePage from './components/website/SystemArchitecturePage';
import CRMHub from './components/website/CRMHub';
import PlatformValuePage from './components/website/PlatformValuePage';
...
import { StaffingCRM } from './components/StaffingCRM';
import EmployerCRM from './components/crm/EmployerCRM';
import PropertyOwnerCRM from './components/crm/PropertyOwnerCRM';
import ResourcePartnerCRM from './components/crm/ResourcePartnerCRM';
...
function AppContent() {
  ...
  if (currentPage === 'service-veterans') {
    return (
      <>
        <SEO {...getSEOConfig()} />
        <FriendAVeteranPage onNavigate={handleNavigate} />
      </>
    );
  }
  ...
  if (currentPage === 'service-staffing') {
    return (
      <>
        <SEO {...getSEOConfig()} />
        <FairPathStaffingPage onNavigate={handleNavigate} />
      </>
    );
  }
  ...
  if (currentPage === 'service-police') {
    return (
      <>
        <SEO title="Police The Police - FairPath Industries" description="Record police interactions. Protect yourself. Get justice." />
        <PoliceThePolicePage onNavigate={handleNavigate} />
      </>
    );
  }
  ...
  if (currentPage === 'service-employers') {
    return (
      <>
        <SEO {...getSEOConfig()} />
        <EmployerListingsPage onNavigate={handleNavigate} />
      </>
    );
  }

  if (currentPage === 'service-properties') {
    return (
      <>
        <SEO {...getSEOConfig()} />
        <PropertyOwnersPage onNavigate={handleNavigate} />
      </>
    );
  }
  ...
  if (currentPage === 'post-job') {
    return (
      <JobPostingForm 
        ...
        currentJobs={(currentUser as any)?.activeJobs || 0} 
  ...
  // PORTAL PAGES - All accessible from main navigation (NO PASSWORD REQUIRED)
  if (currentPage === 'staffing-crm') {
    return <StaffingCRM onBackToHome={() => handleNavigate('home')} />;
  }

  if (currentPage === 'employer-portal') {
    return <EmployerCRM onNavigate={handleNavigate} />;
  }

  if (currentPage === 'property-portal') {
    return <PropertyOwnerCRM onNavigate={handleNavigate} />;
  }

  if (currentPage === 'resource-portal') {
    return <ResourcePartnerCRM onNavigate={handleNavigate} />;
  }
